		...
		<div class="container-width">
			<div class="row-full">
				<div id="cat-sb" class="large-3 columns filter">
					...
					<div class="filter-dropdown filter-options filter-cat">

						<a href="" class="dropdown-btn" data-dropdown="filter-dropdown-cat" aria-expanded="false">
							<span>Sub Categories</span><i class="fi-play"></i>
						</a>
						<ul id="filter-dropdown-cat" aria-controls="link-lifestyle" aria-autoclose="true" class="f-dropdown" data-dropdown-content aria-hidden="true" tabindex="-1">
							<li class="cat-list"><a href="">Halloware</a></li>
							<li class="cat-list"><a href="">Halloware</a></li>
							<li class="cat-list"><a href="">Halloware</a></li>
							<li class="cat-list"><a href="">Halloware</a></li>
						</ul>				
