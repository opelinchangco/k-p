	...
	<div class="large-8 large-centered medium-11 medium-centered columns">
		<ul class="small-block-grid-1 medium-block-grid-3 large-block-grid-3">
			<li class="grid-single">
						...
						<a href="" class="grid-link-wrap" data-reveal-id="grid-single-1"> <!--data-reveal-id value and modal ID must be the same and increme. Incrementing values would do-->
							<div class="grid-link-text">
								...
								<div class="grid-link-edit">
									...
									<h4 class="small-cursive">Cart</h4>
								</div>
				...
				<div id="grid-single-1" class="reveal-modal item-modal buy-item" data-reveal aria-labelledby="grid-single-1" aria-hidden="true" role="dialog">
			...
			<li class="grid-single">
				...
				<div id="grid-single-2" class="reveal-modal item-modal buy-item" data-reveal aria-labelledby="grid-single-2" aria-hidden="true" role="dialog">
				  	<div class="item-slider columns">
				  			<div class="slider-thumb">
								<a data-orbit-link="slide-1" class="small button" style="background: url(img/bg-home-sec-slider.png)"></a>
								<a data-orbit-link="slide-2" class="small button" style="background: url(img/home-grid-big-2.png)"></a>
			...
			<li class="grid-single">
				...
				<div id="grid-single-3" class="reveal-modal item-modal buy-item" data-reveal aria-labelledby="grid-single-3" aria-hidden="true" role="dialog">
				  	<div class="item-slider columns">
				  			<div class="slider-thumb">
								<a data-orbit-link="slide-1" class="small button" style="background: url(img/bg-home-sec-slider.png)"></a>
								<a data-orbit-link="slide-2" class="small button" style="background: url(img/home-grid-big-2.png)"></a>
			...
			<li class="grid-single">
				...
				<div id="grid-single-4" class="reveal-modal item-modal buy-item" data-reveal aria-labelledby="grid-single-4" aria-hidden="true" role="dialog">
				  	<div class="item-slider columns">
				  			<div class="slider-thumb">
								<a data-orbit-link="slide-1" class="small button" style="background: url(img/bg-home-sec-slider.png)"></a>
								<a data-orbit-link="slide-2" class="small button" style="background: url(img/home-grid-big-2.png)"></a>
			...
			<li class="grid-single">
				...
				<div id="grid-single-5" class="reveal-modal item-modal buy-item" data-reveal aria-labelledby="grid-single-5" aria-hidden="true" role="dialog">
				  	<div class="item-slider columns">
				  			<div class="slider-thumb">
								<a data-orbit-link="slide-1" class="small button" style="background: url(img/bg-home-sec-slider.png)"></a>
								<a data-orbit-link="slide-2" class="small button" style="background: url(img/home-grid-big-2.png)"></a>
