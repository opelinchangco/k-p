				...
				<div id="cred-login"class="cred-col large-6 medium-6 columns" data-equalizer-watch>
					...
					<form>
						<div class="row">
							...
							<div class="large-12 columns date">
								<div class="date-container">
									<input class="month" type="text" placeholder="Month">
									<input class="day" type="text" placeholder="Date">
							...
							<div id="forget-pass" class="large-12 columns">
								<a href="">Already a member? Why are you here? Signin.</a>
							</div>																					
						</div>
					</form>
				</div>
...
<?php 
	include ("includes/menu-mobile-couple.php");
